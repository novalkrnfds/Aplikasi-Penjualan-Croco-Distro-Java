...
public class FormDetailTransaksi extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabel12.setText("RIWAYAT TRANSAKSI PENJUALAN BARANG");
        ...
        barangTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "NO. FAKTUR", "NAMA PETUGAS", "TANGGAL TRANSAKSI", "JUMLAH", "BAYAR", "SISA"
            }
        ) {
    ...
    private void deleteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteButtonActionPerformed
        ...
        if(barangTable.getSelectedRowCount() > 0){
            String faktur = barangTableModel.getValueAt(barangTable.getSelectedRow(), 0).toString();
            if(tc.delete(faktur)){
